...
export const loadCaptchaEnginge = (numberOfCharacters, backgroundColor = 'white', fontColor = 'black', charMap = '', fontStyle = '') => {
    ...
    ctx.font = fontStyle === "" ? "italic 20px Arial" : fontStyle;
    ...
    document.getElementById("reload_href").onclick = function () {
        loadCaptchaEnginge(captcha_number, backgroundColor, fontColor, charMap, fontStyle);
    }
...
export const reloadCaptcha = () => {
    loadCaptchaEnginge(captcha_number, backgroundColor_value, fontColor_value, charMap_value, fontStyle_value);
    return true;
}
